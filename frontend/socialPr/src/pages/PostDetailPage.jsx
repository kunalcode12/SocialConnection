...
const PostPage = () => {
  ...
  const hasUserUpvotedComment = (commentId) => {
    return userVotes?.commentVotes?.some(
      (vote) =>
  ...
  const hasUserUpvotedReply = (replyId) => {
    return userVotes?.replyVotes?.some(
      (vote) =>
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-14  mt-2">
      {(isError || success) && (
        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-4">
              <Avatar className="w-12 h-12 ring-2 ring-blue-100 transition-transform hover:scale-105">
                <AvatarImage
                  src={post.user?.profilePicture || "/api/placeholder/40/40"}
                  alt={post?.user.name}
                />
                <AvatarFallback className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white">
                  {post?.user.name?.[0]?.toUpperCase() || "A"}
                </AvatarFallback>
              </Avatar>
              <div className="flex-1">
                <Link to={`/user/${post.user._id}`}>
                  <span className="font-bold text-gray-900 hover:text-blue-600 cursor-pointer transition-all duration-200 hover:underline">
                    {post?.user.name}
                  </span>
                </Link>
                ...
                <p className="mt-2 text-gray-800 text-lg leading-relaxed break-words">
            ...
            <div className="relative">
              ...
              {showMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-100 animate-fade-in-down">
                  <button
                    onClick={handleSave}
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center relative">
        {post.video ? (
          <div className="relative w-full">
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-gray-300/30 backdrop-blur">
              <div
                ref={progressRef}
                className="h-full bg-gradient-to-r from-blue-400 to-blue-600 cursor-pointer"
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-4">
              <Button
                variant="ghost"
                className="bg-white/80 hover:bg-white backdrop-blur-sm rounded-full p-2 transition-all duration-300 hover:scale-105"
      ...
      <div className="bg-white p-4 border-t border-gray-100 flex items-center space-x-6">
        ...
        <Button
          variant="ghost"
          className="hover:bg-gray-100 rounded-full space-x-2 transition-all duration-300 hover:scale-105"
        >
        ...
        >
          <div className="flex-1 relative">
            <input
              ...
              value={newComment}
              className="w-full bg-gray-50 rounded-full px-4 py-3 pr-12 border border-gray-200 focus:border-blue-400 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-all duration-300"
            ...
            <Button
              ...
              variant="ghost"
              size="sm"
              className="absolute right-2 top-1/2 -translate-y-1/2 text-blue-500 hover:text-blue-600 hover:bg-blue-50 disabled:opacity-50 transition-all duration-300"
            ...
            comments.map((comment) => (
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-gray-50 rounded-2xl px-4 py-3 shadow-sm relative group hover:bg-gray-100 transition-colors duration-200">
                            ...
                            >
                              <Avatar className="w-6 h-6 ring-1 ring-blue-100">
                                <AvatarImage
                                  ...
                                  alt={"userPicture"}
                                />
                                <AvatarFallback className="bg-gradient-to-br from-purple-500to-purple-600 text-white text-xs">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center space-x-4 text-xs mt-1 text-gray-500 pl-3">
                                  ...
                                  <button
                                    onClick={() =>
                                      handleUpvoteReply(comment._id, reply._id)
                                    }
                                    className="flex items-center space-x-1 group transition-all duration-200 hover:scale-105"
                                  >
                                    <Heart
